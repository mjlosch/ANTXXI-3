...
#undef RECOM_ATMCO2_BOX
C---------------------

CCV offline coupling to recom-medusa sediment model; switches off the
C   internal calculation of sediment-ocean fluxes and takes them
C   from input files (output from Medusa) instead
#undef RECOM_MEDUSA_OFFLINE

CCV Chlorophyll loss term dependent on PAR and Chl:C		    
#undef RECOM_PHOTODAMAGE
...
#undef RECOM_IRON_VARIABLE_SOLUBILITY
						       
C- settings for sea-ice iron
#undef RECOM_SEAICEIRON
#undef RECOM_SEAICEIRON_HIGH
